    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center mb-10">
        <div className="m-auto w-full text-center md:w-7/12">
          ...
          <h1 className="mb-5 text-3xl font-bold md:text-6xl tracking-tighter">
            {data.title}
          </h1>
      ...
      <div className="relative m-auto mb-10 h-80 w-full max-w-screen-lg overflow-hidden md:mb-20 md:h-[450px] md:w-5/6 md:rounded-2xl lg:w-2/3">
        <Image
          ...
          width={1200}
          height={630}
          className="h0full w-full object-cover"
          priority
        />
      </div>
      <RenderArticle content={data.articleContent as JSONContent} />
    </>
  );
}
